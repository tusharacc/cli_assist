...
[bold]Natural Language:[/bold]
  ...
  "dependencies of class UserService" → Neo4j dependency analysis
  "impact analysis for PaymentController" → Neo4j impact analysis
  "which classes depend on CreateCyberRiskReportResponse" → Neo4j dependency query
...
def _interactive_neo4j(query: str):
